...
#### 3D PCA
  ...
  In order to make the function work we need to supply a subject, time, and the number of time points as in the `three_mode` function. 
...
```{r pca3DSubj, fig.cap="3D Subject PCoA Plot. Plotting principle coordinants collapsing over subject axis.", fig.width=6, fig.height=4}
long_micro %>%
  pca_3d(table = "Family", time_var = day, subject = study_id, 
         modes = "CB", type = "PCoA")
```
